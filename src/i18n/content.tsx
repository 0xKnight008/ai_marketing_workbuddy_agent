...
export interface SiteContent {
  ...
  pricing: {
    ...
    trialNote: string;
    per: string;
    plans: { name: string; cn: string; price: string; target: string; accounts: string; tasks: string; credits: string; features: string[]; cta: string }[];
    overageTitle: string;
    overage: React.ReactNode[];
    taskTitle: string;
    taskRules: React.ReactNode[];
    guardrailTitle: string;
    guardrails: React.ReactNode[];
  };
  faq: {
    badge: string;
    pre: string;
...
const zh: SiteContent = {
  ...
  pricing: {
    ...
    hi: "实际干活的量",
    post: "付费，童叟无欺",
    subtitle: "平台订阅 + 连接账号 + task 额度 + AI credits。触发、过滤、审批通知统统不计费——精灵只为成功的动作收租。",
    bannerPre: "🎁 全部计划均含 ",
    bannerHi: "7 天免费试用 · 30 Eco credits",
    bannerPost: " 体验额度，不满意随时离开",
    recommended: "村长推荐",
    trialNote: "7 天免费试用 · 含 30 Eco credits",
    per: "/ 月",
    plans: [
      {
        name: "Creator",
    ...
    overage: [
      ...
      <>· AI credits 加购：<b className="text-ink">$10 / 1,000 credits</b>；用完高级额度会自动切换到 Eco</>,
    ],
    taskTitle: "✨ 什么算一个 task？",
    taskRules: [
      <>· 触发监听、过滤条件、审批通知：<b className="text-ink">0 task</b></>,
      <>· 成功的对外动作（发布 / 回复 / 写入）：<b className="text-ink">1 task</b></>,
      <>· AI 生成 / 分类：Eco / Standard / Flagship 分别消耗 <b className="text-ink">1 / 6 / 20 AI credits</b>；每档都有独立 token 与目标数上限</>,
      <>· 失败的步骤：<b className="text-ink">不计费</b></>,
    ],
    guardrailTitle: "🛡️ 成本结界怎么保护你？",
    guardrails: [
      <>· 同时监控 <b className="text-ink">task 额度</b> 与 <b className="text-ink">供应商成本</b>（连接账号、X 写入和 AI）</>,
      <>· 达到 <b className="text-ink">80%</b>：通知你，下一次发布需要审批</>,
      <>· 达到 <b className="text-ink">100%</b>：自动暂停新的 AI 与发布；免费动作不受影响。升级计划后自动恢复</>,
    ],
  },
  faq: {
    badge: "问答树洞",
  ...
  footer: {
    ...
    sub: "留下邮箱，第一批搬进精灵村。全部计划均可 7 天免费试用，含 30 Eco credits 体验额度。",
...
const en: SiteContent = {
  ...
  pricing: {
    ...
    subtitle: "Platform subscription + connected accounts + task quota + AI credits. Triggers, filters and approval pings are always free — sprites only charge for successful actions.",
    bannerPre: "🎁 Every plan includes a ",
    bannerHi: "7-day free trial · 30 Eco credits",
    bannerPost: " — leave anytime, no hard feelings",
    recommended: "Village pick",
    trialNote: "7-day free trial · 30 Eco credits included",
    per: "/ mo",
    plans: [
      {
        name: "Creator",
        ...
        tasks: "2,000 tasks / mo",
        credits: "400 AI credits / mo",
    ...
    overage: [
      ...
      <>· AI credit top-up: <b className="text-ink">$10 / 1,000 credits</b>; when premium credits run out, runs automatically fall back to Eco.</>,
    ],
    ...
    taskRules: [
      ...
      <>· AI generation / classification: Eco / Standard / Flagship use <b className="text-ink">1 / 6 / 20 AI credits</b>; each band has its own token and target cap</>,
      <>· Failed steps: <b className="text-ink">free</b></>,
    ],
    guardrailTitle: "🛡️ How the cost guardrail protects you",
    guardrails: [
      <>· We meter both your <b className="text-ink">task quota</b> and <b className="text-ink">supplier spend</b> (connected accounts, X writes, and AI)</>,
      <>· At <b className="text-ink">80%</b>: we notify you and require approval before the next publish</>,
      <>· At <b className="text-ink">100%</b>: new AI runs and publishes pause automatically; free actions keep working. Upgrade your plan to resume</>,
    ],
  },
  faq: {
  ...
  footer: {
    ...
    l2hi: "night shift",
    tagline: "your workbuddy never sleeps",
    sub: "Leave your email and be among the first to move into Sprite Village. Every plan starts with a 7-day free trial and 30 Eco credits.",
...
const es: SiteContent = {
  ...
  pricing: {
    ...
    hi: "realmente hecho",
    post: ", sin trucos",
    subtitle: "Suscripción + cuentas conectadas + cuota de tareas + créditos de IA. Disparadores, filtros y avisos de aprobación siempre son gratis — los duendes solo cobran por acciones exitosas.",
    bannerPre: "🎁 Todos los planes incluyen ",
    bannerHi: "7 días gratis · 30 créditos Eco",
    bannerPost: " — vete cuando quieras",
    recommended: "Elegido por la aldea",
    trialNote: "7 días gratis · 30 créditos Eco incluidos",
    per: "/ mes",
    plans: [
      {
        name: "Creator",
        ...
        accounts: "2 cuentas conectadas",
        tasks: "2.000 tareas / mes",
        credits: "400 créditos de IA / mes",
      ...
      },
      {
        ...
        credits: "8.000 créditos de IA / mes",
    ...
    overage: [
      ...
      <>· Recarga de créditos de IA: <b className="text-ink">$10 / 1.000 créditos</b>; al agotar créditos premium, la ejecución pasa automáticamente a Eco.</>,
    ],
    ...
    taskRules: [
      ...
      <>· Generación o clasificación IA: Eco / Standard / Flagship usan <b className="text-ink">1 / 6 / 20 créditos de IA</b>; cada nivel tiene su límite de tokens y destinos</>,
      <>· Pasos fallidos: <b className="text-ink">gratis</b></>,
    ],
    guardrailTitle: "🛡️ Cómo te protege el límite de coste",
    guardrails: [
      <>· Medimos tanto tu <b className="text-ink">cuota de tareas</b> como el <b className="text-ink">gasto de proveedores</b> (cuentas conectadas, escrituras en X e IA)</>,
      <>· Al <b className="text-ink">80%</b>: te avisamos y la próxima publicación necesita aprobación</>,
      <>· Al <b className="text-ink">100%</b>: se pausan automáticamente las nuevas ejecuciones de IA y publicaciones; las acciones gratuitas siguen. Sube de plan para reanudar</>,
    ],
  },
  faq: {
  ...
  footer: {
    ...
    l2hi: "a los duendes",
    tagline: "your workbuddy never sleeps",
    sub: "Deja tu email y sé de los primeros en mudarte a la aldea. Todos los planes empiezan con 7 días gratis y 30 créditos Eco.",

...
const en: SiteContent = {
  ...
  governance: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: "Every AI decision, tool call, input/output and task cost is on record. Full accounts in under a minute.",
      },
      {
        title: "Secret Vault",
  ...
  footer: {
    ...
    buttonDone: "Got it!",
    doneNote: "The sprites have memorized you — a letter is on its way!",
    columns: [
...
const es: SiteContent = {
  htmlLang: "es",
  docTitle: "Piggybot — Tu gemelo digital para el marketing",
  nav: {
    links: [
  ...
  copilot: {
    badge: "Demo de hechizo · AI Copilot Builder",
    ...
    steps: [
      ...
      { label: "Enviar a Slack", detail: "@a los compañeros para revisar" },
    ],
  ...
  integrations: {
    ...
    saasSub: "Pocos pero potentes: CRM, hojas de cálculo, mensajería, documentos y ganchos universales",
    saas: [
      { name: "HubSpot", c: "#FADCCB" }, { name: "Salesforce", c: "#CFE7F5" }, { name: "Google Sheets", c: "#D6ECD9" },
      { name: "Airtable", c: "#FBE3C8" }, { name: "Slack", c: "#E8DEF0" }, { name: "Lark", c: "#D0E3F8" },
      { name: "Notion", c: "#ECEAE4" }, { name: "Google Docs", c: "#D5E6F8" }, { name: "Webhook / HTTP", c: "#F5EBD3" },
  ...
  pricing: {
    badge: "Farolillos de precios · Pricing",
    ...
    overage: [
      ...
      <>· Tareas IA premium: generación con modelo frontera ≈ <b className="text-ink">3 tareas estándar</b></>,
    ],
  ...
  footer: {
    ...
    buttonDone: "¡Recibido!",
    doneNote: "¡Los duendes ya te han memorizado — la carta está en camino!",
    columns: [
      { title: "Producto", links: ["Constructor de flujos", "AI Copilot", "Galería de plantillas", "Bandeja unificada", "Panel de uso"] },
